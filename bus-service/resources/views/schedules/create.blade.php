...
<form method="POST" action="{{ route('schedules.store') }}">
  ...
  <div class="row">
    <div class="col-md-6 mb-3">
      ...
      <input type="datetime-local" name="departure_at" class="form-control" value="{{ old('departure_at') }}" required>
      @error('departure_at')<div class="text-danger">{{ $message }}</div>@enderror
    </div>
    <div class="col-md-6 mb-3">
      <label class="form-label">Arrival Time</label>
      <input type="datetime-local" name="arrival_at" class="form-control" value="{{ old('arrival_at') }}">
  ...
  <div class="row">
    <div class="col-md-6 mb-3">
      ...
      <input type="number" name="available_seats" class="form-control" value="{{ old('available_seats', 30) }}" min="1" required>
