...
<table class="table table-striped">
  <thead>
    <tr><th>ID</th><th>Plate</th><th>Name</th><th>Capacity</th><th>Type</th><th>Actions</th></tr>
  </thead>
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        <form action="{{ route('buses.destroy',$bus) }}" method="POST" style="display:inline-block" onsubmit="return confirm('Delete?')">
          @csrf @method('DELETE')
